...
public final class Fairy implements active,moving{
    public String id;
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        if (fairyTarget.isPresent()) {
            ...
            if (this.moveTo(world, fairyTarget.get(), scheduler)) {
                ...
                animatedEntity sapling = new Sapling(Sapling.SAPLING_KEY + "_" + fairyTarget.get().getID(), tgtPos, imageStore.getImageList(Sapling.SAPLING_KEY), 0);
